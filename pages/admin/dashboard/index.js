                ...
                <div className="divide-y divide-gray-300">
                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                        ...
                        <li onClick={handleChatClick}>
                            <Link href={'/admin/dashboard/chat'} rel="noopener noreferrer" className="flex items-center p-2 space-x-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
                        ...
                        <li>
                            <Link rel="noopener noreferrer" href={'/admin/dashboard/blogs'} className="flex items-center p-2 space-x-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-600">
